...
export default function Nav({ currentScreen, onNavigate, variant = 'app' }: NavProps) {
  const { isWalletConnected, walletAddress, connectWallet, disconnectWallet, isUsingMockData } = variant === 'app' ? useGlobalState() : { isWalletConnected: false, walletAddress: '', connectWallet: () => {}, disconnectWallet: () => {}, isUsingMockData: false };
